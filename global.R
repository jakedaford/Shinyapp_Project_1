...
# count_collisions_by_zipcode = collisions %>%
#   group_by(zip_code) %>%
#   summarise(n())

count_collisions_by_borough

# count_collisions_by_zipcode

count_lethal_collisions_by_borough = lethal_collisions %>%
  group_by(borough) %>%
  summarise(lethal_accidents = n())

# count_lethal_collisions_by_zipcode = lethal_collisions %>%
#   group_by(zip_code) %>%
#   summarise(n())

count_lethal_collisions_by_borough

# count_lethal_collisions_by_zipcode
